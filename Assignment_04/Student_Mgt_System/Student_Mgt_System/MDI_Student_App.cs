...
namespace Student_Mgt_System
{
    public partial class MDI_Student_App : Form
    {
        ...
        private void addCourseListToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void maximumFrom2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start(@"C:\Users\admin\Desktop\C_Program\Maximum From 2.exe");
        }
    }
}
